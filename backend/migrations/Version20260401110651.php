 ...
 */
final class Version20260401110651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE expenses_reports CHANGE name name VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE expenses_reports CHANGE name name VARCHAR(255) DEFAULT NULL');
