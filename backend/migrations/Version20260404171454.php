 ...
 */
final class Version20260404171454 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE km_mileage_rates ADD type VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE waiver_mileage_rates ADD type VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE km_mileage_rates DROP type');
        $this->addSql('ALTER TABLE waiver_mileage_rates DROP type');
    }
}
