 ...
 */
final class Version20260402100803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE infos_requests CHANGE amount_waiver amount_waiver NUMERIC(7, 2) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE infos_requests CHANGE amount_waiver amount_waiver NUMERIC(7, 2) NOT NULL');
    }
}
